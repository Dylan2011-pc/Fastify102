...
<div className="inputsearchdevicechoduyet">
        <Col >
                      <Form.Control placeholder="Tìm kiếm thiết bị" className='inputcho' onChange = {(e)=>setnamesearch(e.target.value)} />
     ...
     <option value={nhom.id} key={index}>{nhom.Name}</option>
                    ...
                    <button type="button" className="btn btn-success buttonsearch" onClick={()=>handleSearchDeviceChoduyet()}>Tìm
