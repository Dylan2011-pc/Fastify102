...
closeOnClick/>
   ...
   <Header/>
        ...
        <div className="listdevicemuon">
    <table className='bang1'>
          <div className = "formSearch">
       
                    <Col>
                    <FormControl placeholder="Tìm kiếm thiết bị" className='inputsearch' onChange = {(e)=>setnamesearch(e.target.value)} />
                    </Col>
                    ...
                    <button type="button" class="btn" className="btn buttonsearch" onClick={()=>handleSearchDevice()}>
                    Tìm 
                    ...
                    <Button className="buttoncreatedevice" onClick={()=>handleCreateDevice()} >Thêm thiết bị<i class="fa fa-plus" aria-hidden="true"></i></Button>
        </div>
  <tr className='tabledevice'>
    <th>STT</th>
    <th>Tên thiết bị</th>
    <th>Ảnh</th>
